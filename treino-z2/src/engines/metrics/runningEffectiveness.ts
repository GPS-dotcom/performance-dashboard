...
/**
 * Running Effectiveness: speed produced per unit of power relative to
 * body weight -- speed (m/min) / power (W/kg). Higher is more efficient
 * (more speed for the same relative power output).
 */
