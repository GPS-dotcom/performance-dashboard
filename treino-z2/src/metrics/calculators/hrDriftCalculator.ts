...
/**
 * HR Drift (aerobic decoupling), Pa:HR method (Maffetone; popularized for
 * endurance coaching by TrainingPeaks): split an activity's records into
 * two equal-duration halves, compute the average speed:HR ratio in each
 * half, and express the change as a percentage of the first half's
